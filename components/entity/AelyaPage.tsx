  ...
  return (
    <div className="min-h-screen bg-[#F7F3EA] p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <h1 className="font-['Playfair_Display'] text-[42px] font-bold  text-[#1C1814] flex items-center gap-4">
        ...
        <div className="grid grid-cols-3 gap-4 mt-8">
          <div className="bg-[#FDFAF3] border border-[rgba(60,52,40,0.10)] rounded-none-none p-5">
            ...
            <div className="font-['Playfair_Display'] text-[36px] font-bold text-[#1C1814]">100</div>
          ...
          <div className="bg-[#FDFAF3] border border-[rgba(60,52,40,0.10)] rounded-none-none p-5">
            ...
            <div className="font-['Playfair_Display'] text-[36px] font-bold text-[#1C1814]">23</div>
          ...
          <div className="bg-[#FDFAF3] border border-[rgba(60,52,40,0.10)] rounded-none-none p-5">
            ...
            <div className="font-['Playfair_Display'] text-[36px] font-bold text-[#1C1814]">94%</div>
            <div className="font-['Noto_Sans'] text-[11px] text-[#918977]">score RGPD</div>
          </div>
        </div>

        <div className="mt-8">
          <h2 className="font-['Playfair_Display'] text-[20px] font-bold  text-[#1C1814] mb-4">Modules</h2>
          <div className="space-y-3">
            {modules.map(m => (
              <div key={m.name} className="bg-[#FDFAF3] border border-[rgba(60,52,40,0.10)] rounded-none-none p-4 flex items-center justify-between">
                <div>
                ...
                <div className="flex items-center gap-3">
                  <div className="w-32 h-1.5 bg-[#F2EFE8] rounded-none-none overflow-hidden">
                    <div className="h-full bg-[#B8963E] rounded-none-none" style={{ width: `${m.progress}%` }} />
                  </div>
        ...
        <div className="mt-8 flex gap-3">
          <a href="/aelya" className="inline-flex items-center gap-2 px-4 py-2 bg-[#1C1814] text-[#D4B662] rounded-none font-['JetBrains_Mono'] text-[10px] hover:bg-[#252019]">
