      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-3 gap-4 mt-8">
          <div className="bg-[#FDFAF3] border border-[rgba(60,52,40,0.10)] rounded-none-none p-5">
            ...
            <div className="font-['Playfair_Display'] text-[36px] font-bold text-[#1C1814]">23.7K</div>
        ...
        <div className="mt-8">
          ...
          <div className="space-y-3">
            {trails.map(t => (
              <div key={t.name} className="bg-[#FDFAF3] border border-[rgba(60,52,40,0.10)] rounded-none-none p-4 flex items-center justify-between">
                <div>
        ...
        <div className="mt-8 flex gap-3">
          <a href="/burhan" className="inline-flex items-center gap-2 px-4 py-2 bg-[#1C1814] text-[#D4B662] rounded-none font-['JetBrains_Mono'] text-[10px] hover:bg-[#252019]">
