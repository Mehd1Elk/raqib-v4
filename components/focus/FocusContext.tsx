...
export const FOCUS_MODES: FocusMode[] = [
  ...
  { id: 'noos-mvp', label: 'NOOS MVP', description: 'Kappa \u2265 0.75, 37 items', color: '#B8963E', entities: ['noos','aelya','burhan'], layers: ['n01','n11','n21','n31','n41','n51','n61','n71'] },
  ...
  { id: 'fundraising', label: 'Fundraising', description: 'Seed \u20ac15-45M', color: '#D4B662', entities: ['eigen','cg'], layers: ['ei41','ei42','ei48','ei61','ei64'] },
];
