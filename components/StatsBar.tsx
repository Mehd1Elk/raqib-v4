...
export function StatsBar({ entity, stats }: StatsBarProps) {
  return (
    ...
    >
      <div>
        <span className="text-lg font-[family-name:var(--font-cormorant)] font-bold italic text-noir">
          {entity.name}
        </span>
        <span className="text-[11px] font-[family-name:var(--font-noto)] text-t3 ml-3">
          {entity.description}
        </span>
      </div>
