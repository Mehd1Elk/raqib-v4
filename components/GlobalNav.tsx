    ...
    <div ref={ref} className="relative">
      ...
      {open && (
        <div className="absolute right-0 top-full mt-1 w-[280px] bg-ivory border border-div rounded-none-none shadow-lg z-50 py-2">
          ...
          <a href="/nexus" className="block px-3 py-2 hover:bg-[rgba(30,10,32,0.04)] font-[family-name:var(--font-cormorant)] text-[13px] italic font-bold text-[#1E0A20]">Nexus &mdash; Carte ecosysteme</a>
          <a href="/eigen" className="block px-3 py-2 hover:bg-[rgba(30,10,32,0.04)] font-[family-name:var(--font-cormorant)] text-[13px] italic font-bold text-noir">EIGEN Strategique</a>
          ...
          <a href="/corridor" className="block px-3 py-2 hover:bg-[rgba(30,10,32,0.04)] font-[family-name:var(--font-cormorant)] text-[13px] italic font-bold" style={{ color: '#1E0A20' }}>Corridor Intelligence — 49 pays</a>
          <a href="/acquisition" className="block px-3 py-2 hover:bg-[rgba(30,10,32,0.04)] font-[family-name:var(--font-cormorant)] text-[13px] italic font-bold" style={{ color: '#1E0A20' }}>Intelligence d&apos;Acquisition — 396 cibles</a>
          <a href="/science" className="block px-3 py-2 hover:bg-[rgba(30,10,32,0.04)] font-[family-name:var(--font-cormorant)] text-[13px] italic font-bold" style={{ color: '#6366F1' }}>Intelligence Scientifique — 7 domaines</a>
          ...
          <a href="/data" className="block px-3 py-1.5 hover:bg-[rgba(30,10,32,0.04)] font-[family-name:var(--font-cormorant)] text-[13px] italic font-bold text-noir">Data Viewer &mdash; 1100 couches</a>
