    ...
    <div ref={ref} className="relative">
      ...
      {open && (
        <div className="absolute right-0 top-full mt-1 w-[280px] bg-ivory border border-div rounded-none-none shadow-lg z-50 py-2">
          ...
          <a href="/acquisition" className="block px-3 py-2 hover:bg-[rgba(184,150,62,0.08)] font-[family-name:var(--font-cormorant)] text-[13px] italic font-bold" style={{ color: '#C9A96E' }}>Intelligence d&apos;Acquisition</a>
