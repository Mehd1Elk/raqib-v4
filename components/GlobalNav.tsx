    ...
    <div ref={ref} className="relative">
      ...
      {open && (
        <div className="absolute right-0 top-full mt-1 w-[280px] bg-ivory border border-div rounded-none-none shadow-lg z-50 py-2">
          ...
          <a href="/dashboards/supervisor" className="block px-3 py-1.5 hover:bg-[rgba(184,150,62,0.08)] font-[family-name:var(--font-noto)] text-[11px] text-walnut pl-6">Superviseur (Agent 0)</a>
