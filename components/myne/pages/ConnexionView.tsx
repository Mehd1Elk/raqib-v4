...
export default function ConnexionView() {
  ...
  const labelStyle = {
    fontFamily: BD, fontSize: 12, fontWeight: 600 as const,
      ...
      <div style={{ width: '100%', maxWidth: 480 }}>
        <MYNECard style={{ padding: 32 }}>
          <div style={{ textAlign: 'center', marginBottom: 28 }}>
            <div style={{ fontFamily: MN, fontSize: 28, fontWeight: 700, color: M.gold, marginBottom: 8 }}>MYN&#949;</div>
            <h2 style={{ fontFamily: HD, fontSize: 22, fontWeight: 700, color: M.t1, margin: '0 0 8px' }}>{CONNEXION_CONTENT.headline}</h2>
          ...
          {!submitted ? (
            <form onSubmit={e => { e.preventDefault(); setSubmitted(true); }}>
              ...
              <button type="submit" style={{
                ...
                fontFamily: BD, fontSize: 15, fontWeight: 700, border: 'none', borderRadius: 8,
            ...
            <div style={{ textAlign: 'center', padding: '24px 0' }}>
              ...
              <div style={{ fontFamily: BD, fontSize: 16, fontWeight: 600, color: M.green }}>Inscription enregistrée</div>
              <div style={{ fontSize: 13, color: M.t2, marginTop: 8 }}>Nous vous contacterons dès que votre accès sera prêt.</div>
            </div>
          )}

          <div style={{ textAlign: 'center', marginTop: 20 }}>
            <div style={{ fontFamily: MN, fontSize: 14, color: M.gold, fontWeight: 700 }}>{CONNEXION_CONTENT.social_proof}</div>
