...
export default function NexusMiniInfo() {
  ...
  if (selectedFlow) {
    return (
      <div className="absolute bottom-4 right-4 z-20 w-[280px] bg-[#252019]/90 backdrop-blur-md border border-[rgba(212,182,98,0.15)] rounded-lg p-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="text-center">
            <div className="font-[family-name:var(--font-cormorant)] text-[18px] text-[#D4B662]">
              {selectedFlow.volume}%
            </div>
  ...
  return (
    <div className="absolute bottom-4 right-4 z-20 w-[300px] bg-[#252019]/90 backdrop-blur-md border border-[rgba(212,182,98,0.15)] rounded-lg p-4">
      ...
      <div className="grid grid-cols-3 gap-2 mb-3">
        <div className="text-center">
          <div className="font-[family-name:var(--font-cormorant)] text-[16px] text-[#D4B662]">
            1842
          </div>
          <div className="font-[family-name:var(--font-jetbrains)] text-[6px] text-[#918977]">
            ENTRIES
      ...
      <a
        ...
        className="block mt-2 text-center py-2 bg-[#B8963E] text-white rounded font-[family-name:var(--font-jetbrains)] text-[9px] hover:bg-[#9A7B32] transition-colors"
      >
