  ...
  return (
    <div data-card className="bg-[#FDFAF3] border border-[rgba(60,52,40,0.10)] rounded-lg p-4">
      <div className="flex items-center justify-between mb-3">
        <div>
          <div className="font-[family-name:var(--font-cormorant)] text-[16px] font-bold italic text-[#1C1814]">
        ...
        <div className="font-[family-name:var(--font-cormorant)] text-[22px] font-bold text-[#B8963E]">
          {formatted}
        </div>
      </div>
      <div className="grid grid-cols-3 gap-3">
        {data.croissance && (
          <div className="text-center p-2 bg-[#F7F3EA] rounded">
