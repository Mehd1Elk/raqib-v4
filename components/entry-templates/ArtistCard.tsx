export default function ArtistCard({ data }: { data: Record<string, any> }) {
  return (
    <div data-card className="bg-[#FDFAF3] border border-[rgba(60,52,40,0.10)] rounded-lg p-4">
      <div className="font-[family-name:var(--font-cormorant)] text-[16px] font-bold italic text-[#1C1814]">{data.artiste || data.nom}</div>
      ...
      {data.cote_enchères_max_USD && (
        <div className="mt-2 font-[family-name:var(--font-cormorant)] text-[18px] font-bold text-[#B8963E]">
