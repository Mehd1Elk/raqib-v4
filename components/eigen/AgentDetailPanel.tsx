      ...
      >
        <div className="p-6">
          ...
          <div className="flex justify-between items-start mb-6 border-b border-stone-200 pb-4">
            <div>
              ...
              <div className="flex items-center space-x-2 text-xs font-mono text-stone-600">
                <span className="bg-stone-100 px-2 py-0.5 rounded-none text-[#D4AF37] font-semibold">{agent.layer}</span>
                <span>·</span>
                <span>Pôle {agent.pole}</span>
              </div>
            </div>
            <button onClick={onClose} className="p-1 hover:bg-stone-100 rounded-none-none text-stone-500 transition-colors">
              <X size={20} />
            </button>
          </div>
          ...
          <div className="mb-6">
            ...
            <p className="text-sm text-stone-700 leading-relaxed bg-stone-50 p-3 rounded-none rounded-none-none border-l-2 border-[#D4AF37]">
              {agent.instructions}
            </p>
          </div>
          ...
          <div className="space-y-3">
            <button className="w-full flex items-center justify-center space-x-2 py-3 bg-[#D4AF37] hover:bg-[#C5A028] text-white font-semibold rounded-none transition-colors shadow-sm">
              <PlayCircle size={18} />
