...
export function EigenDashboard({ initialTab }: { initialTab: string }) {
  ...
  return (
    <div className="w-screen h-screen flex flex-col bg-[#1E0A20] overflow-hidden">
      <div className="h-[52px] shrink-0 flex items-center justify-between px-6 border-b border-[rgba(250,248,252,0.12)] bg-[#FAF8FC] z-20">
        <div className="flex items-center gap-3.5">
          <div className="w-1.5 h-1.5 rounded-none-none bg-[#1E0A20]" />
          <span className="font-[family-name:var(--font-cormorant)] text-[20px] font-normal uppercase text-[#1E0A20] tracking-[3px]">
            EIGEN
          </span>
          <div className="w-px h-5 bg-[rgba(30,10,32,0.12)]" />
          <span className="text-[9px] text-[rgba(30,10,32,0.45)] font-[family-name:var(--font-jetbrains)] tracking-[2px] uppercase">
        ...
        <div className="block sm:hidden flex-1 max-w-[150px] ml-auto">
          <select
            ...
            className="w-full bg-[#EEEBF4] border border-[rgba(30,10,32,0.08)] text-[#1E0A20] text-[10px] font-[family-name:var(--font-jetbrains)] px-2 py-1 outline-none"
          >
