        ...
        {data.map((evt, idx) => {
          ...
          return (
            ...
            >
              ...
              <div className="bg-[#1A1A1A] border border-stone-800 group-hover:border-[#B8963E]/50 rounded-none p-4 h-full flex flex-col transition-all group-hover:-translate-y-1 group-hover:shadow-[0_4px_20px_rgba(184,150,62,0.1)]">
                {/* Header: Date + Marqueur Numérique */}
                <div className="flex justify-between items-start mb-3">
                  <div className="bg-stone-900 text-[#B8963E] text-[10px] font-[family-name:var(--font-jetbrains)] px-2 py-1 rounded-none">
                ...
                <div className="absolute -top-1.5 left-1/2 -translate-x-1/2 w-3 h-3 rounded-none-none bg-[#111111] border-2 border-stone-700 group-hover:border-[#B8963E] transition-colors shadow"></div>
              </div>
            </div>
          );
        })}
